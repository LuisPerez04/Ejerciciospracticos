...
public static String[][] aCodigo;
    ...
    static String sexo;
    public static void Personajes_star(){ 
    ...
    public static void main(String[] args) {
       Scanner sc = new Scanner(System.in);
        System.out.println("Introduce un número para elegir el programa: \n Traductor a codigo morse ---> 1 \n Eleccion de sexo personajes Star wars ---> 2 \n Quizz de programacion ----> 3");
        int numero = sc.nextInt();
        programa_eleccion(numero);
    }
    public static void programa_eleccion(int numeroEscogido){
        Scanner sc = new Scanner(System.in);
        switch(numeroEscogido){
            case 1:
                System.out.println("Escribe una frase que sea de tu agrado");
                String frase = sc.nextLine().toUpperCase();
                char Frase[] = frase.toCharArray();
                arrayList();
                //bucle
                sentencia_bucle(frase, Frase);
                System.out.println(Pago(frase, Frase));
                break;
            case 2:
                System.out.println("Introduce el genero que quieres conocer ");
            ...
            case 3:
                ...
                recorrido();
                System.out.println();
                System.out.println("Obtuviste  " + contador + " de Calificacion");
                break;
            default:
    ...
    public static void sentencia_bucle(String frase, char carFrase[]){
    ...
    public static String Pago(String frase, char carFrase[]){
        ...
        return "El Numero de palabras son: " + contador + "\n" + "Pagaras $" + precio;
    }
    public static void genero_star(String genero){
        sexo = genero;
    ...
    public static void cuestionarioQuizz() {
    ...
    public static void respuestasQuizz() {
